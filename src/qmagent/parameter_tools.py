"""Observation-only arithmetic for the calibration protocol.

Produces candidate values, never chooses the next experiment or commits state.
The model never supplies these fitted numbers when this helper is selected.
"""
import math
...
def calculate_fit_updates(observation, state):
    ...
    return {"tool": "analysis.calculate_fit_updates", "version": "1.0", "updates": updates,
